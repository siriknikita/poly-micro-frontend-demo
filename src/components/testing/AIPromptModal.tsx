...
export const AIPromptModal = memo<AIPromptModalProps>(({
  ...
  const [prompt, setPrompt] = useState(
    test?.name ? DEFAULT_PROMPTS.GENERATE_TEST(test?.name) : ''
  );
  ...
  return (
    <div data-testId='ai-prompt-modal' className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
