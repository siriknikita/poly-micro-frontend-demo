...
export const WelcomeGuidance: React.FC = () => {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className={`max-w-md p-6 rounded-lg shadow-xl ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'}`}>
        <button 
        ...
        <p className="mb-6">
          This quick tour will help you understand how to use the application effectively. 
          You can replay this guide anytime from your user menu.
        </p>
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className={`max-w-md p-6 rounded-lg shadow-xl ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'}`}>
        ...
        <p className="mb-6">
          You're now ready to use Poly Micro Manager. If you need to see this guide again, 
          click on your profile at the bottom of the sidebar and select "Show Guide".
        </p>
