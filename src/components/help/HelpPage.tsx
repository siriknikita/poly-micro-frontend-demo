...
export const HelpPage: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <SectionHeader title="Help Center" HeaderIcon={HelpCircle} headerClassName="text-gray-800 dark:text-white text-xl font-semibold flex items-center gap-2 mb-6" iconClassName="h-6 w-6 text-indigo-600 dark:text-indigo-400" />
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-8 mt-8">
        <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Didn't find what you're looking for?</h2>
