...
describe('AskQuestionForm Component', () => {
  ...
  it('validates email format', async () => {
    ...
    await user.type(screen.getByLabelText('Your Question'), 'This is a test question that is long enough.');
  ...
  it('submits the form when all fields are valid', async () => {
    ...
    await user.type(screen.getByLabelText('Email'), 'test@example.com');
    await user.selectOptions(screen.getByLabelText('Category'), 'general');
    await user.type(screen.getByLabelText('Your Question'), 'This is a test question that is long enough to pass validation.');
