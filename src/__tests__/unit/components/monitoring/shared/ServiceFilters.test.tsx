...
jest.mock('@/components/monitoring/shared/ServiceFilterDialog', () => ({
  ServiceFilterDialog: ({ isOpen, onClose, onApplyFilter, initialFilterGroup }: {
    isOpen: boolean;
    onClose: () => void;
    onApplyFilter: (filterGroup: { operator: string; conditions: Array<{ field: string; value: string }> }) => void;
    ...
    return (
      <div data-testid="filter-dialog" className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
